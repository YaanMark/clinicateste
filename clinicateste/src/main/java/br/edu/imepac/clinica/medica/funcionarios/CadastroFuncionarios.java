...
public class CadastroFuncionarios extends JFrame {
    ...
    private final JComboBox<Integer> comboIdPerfil;
    ...
    private JTextField campoIdPerfil;
    ...
    public CadastroFuncionarios() {
        ...
        Integer[] idsPerfis = {1, 2, 3, 4};
        comboIdPerfil = new JComboBox<>(idsPerfis);
    ...
    private void estilizarComboBox(JComboBox<Integer> comboIdPerfil) {
    }
    ...
    private void acaoBotaoSalvar() {
        if (areAllFieldsFilled(campoUsuario, campoNome, campoIdade, campoSexo, campoCpf,
                campoRua, campoBairro, campoCidade, campoEstado, campoContato, campoEmail, campoSenha, campoIdPerfil)  &&
            ...
            funcionario.setSenha(campoSenha.getPassword());
            try {
                funcionario.setIdPerfil(Integer.parseInt(campoIdPerfil.getText()));
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "ID Perfil deve ser um número inteiro válido.", "Erro de Validação", JOptionPane.ERROR_MESSAGE);
                return;
            }
