...
public class FuncionariosDao {
    ...
    public void salvar(Funcionarios funcionarios) throws SQLException {
        String sql = "INSERT INTO funcionarios (usuario, nome, idade, sexo, cpf, rua, bairro, cidade, estado, contato, email, dataNascimento, idPerfil, senha) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public Funcionarios buscarPorId(int id) throws SQLException {
        ...
        if (rs.next()) {
            ...
            f.setUsuario(rs.getString("usuário"));
            ...
            f.setDataNascimento(LocalDate.parse(rs.getString("Data de Nascimento")));
            f.setIdPerfil(rs.getInt("IdPerfil"));
